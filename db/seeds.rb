...
# Categories
ror = Category.create(name: 'fcvflix')
talks = Category.create(name: 'Talks')
testes = Category.create(name: 'Testes')
outros = Category.create(name: 'Outros')

# Featured Movie
movie1 = Movie.create(title: "FCVFLIX - Uma nova maneira de diversão", description: "Criando um clone do NETFLIX, o nosso FCVFLIX em Ruby On Rails...", thumbnail_key: "rails-api1.png", thumbnail_cover_key: "rails-api-cover.png", video_key: "rails-api1.mp4", highlighted: true, category: ror, featured_thumbnail_key: "rails-api-featured.png")
